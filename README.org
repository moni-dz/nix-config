 ...
 * If you don't want to compile the XanMod kernel, set [[https://github.com/fortuneteller2k/nix-config/blob/master/nixos/configuration.nix#L7][kernelPackages]] to something that's in the Nixpkgs build cache, i.e. =pkgs.linuxPackages_zen=
